...
First, ports `80` and `443` should be forwarded on your router. (Port forwarding 5000, to access outside your network is <b>NOT recommended</b>, just warning you, using reverse-proxies like Caddy is best practice) 
